...
const HopitalList = () => {
    ...
    const newData = feedbacks.filter((feedback) => {
      return (
        feedback.feedback_name
          .toLowerCase()
          .includes(search_text.search_text.toLowerCase()) ||
        feedback.feedback_city
          .toLowerCase()
          .includes(search_text.search_text.toLowerCase()) ||
  ...
  const onChange = (e) => setSearchData({ [e.target.name]: e.target.value });
          ...
          <div className="row">
            <div className="col-md-12">
              <div>
                ...
                These all are available Packers and Movers Agent. Kindly click
                on the packers and movers to see the details of it.
              </div>
              <br />
                ...
                <div className="form-group">
                  ...
                  <div className="col-sm-4">
                    <input
                      ...
                      placeholder="Search Agents/Cities/States"
                      required
                    />
                  </div>
                  <div className="col-sm-4">
          ...
          <div className="row">
            {filteredData.map((feedback) => (
              <div className="col-sm-4 info-blocks">
                <i className="icon-info-blocks">
                  <Link to={"/feedback-details/" + feedback.feedback_id}>
                    <img src="img/movers.jpeg" width={50} />
                  </Link>
                </i>
                <div className="info-blocks-in">
                  <h3>
                    <Link to={"/feedback-details/" + feedback.feedback_id}>
                      {feedback.feedback_name} ({feedback.feedback_city})
                    </Link>
                  </h3>
                  <p>
                    <table>
